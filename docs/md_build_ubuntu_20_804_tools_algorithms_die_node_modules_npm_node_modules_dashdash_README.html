...
<p>Follow <a href="https://twitter.com/intent/user?screen_name=trentmick" target="_blank">@trentmick</a> for updates to node-dashdash.</p>
<h1><a class="anchor" id="autotoc_md6342"></a>
Install</h1>
<pre class="fragment">npm install dashdash
</pre><h1><a class="anchor" id="autotoc_md6343"></a>
Usage</h1>
...
<p>console.log("opts:", opts); console.log("args:", opts._args); </p><div class="fragment"><div class="line"># Longer Example</div>
<div class="line"> </div>
<div class="line">A more realistic [starter script &quot;foo.js&quot;](./examples/foo.js) is as follows.</div>
<div class="line">This also shows using `parser.help()` for formatted option help.</div>
<div class="line"> </div>
<div class="line">```javascript</div>
<div class="line">var dashdash = require(&#39;./lib/dashdash&#39;);</div>
<div class="line"> </div>
<div class="line">var options = [</div>
<div class="line">    {</div>
<div class="line">        name: &#39;version&#39;,</div>
<div class="line">        type: &#39;bool&#39;,</div>
<div class="line">        help: &#39;Print tool version and exit.&#39;</div>
<div class="line">    },</div>
<div class="line">    {</div>
<div class="line">        names: [&#39;help&#39;, &#39;h&#39;],</div>
<div class="line">        type: &#39;bool&#39;,</div>
<div class="line">        help: &#39;Print this help and exit.&#39;</div>
<div class="line">    },</div>
<div class="line">    {</div>
<div class="line">        names: [&#39;verbose&#39;, &#39;v&#39;],</div>
<div class="line">        type: &#39;arrayOfBool&#39;,</div>
<div class="line">        help: &#39;Verbose output. Use multiple times for more verbose.&#39;</div>
<div class="line">    },</div>
<div class="line">    {</div>
<div class="line">        names: [&#39;file&#39;, &#39;f&#39;],</div>
<div class="line">        type: &#39;string&#39;,</div>
<div class="line">        help: &#39;File to process&#39;,</div>
<div class="line">        helpArg: &#39;FILE&#39;</div>
<div class="line">    }</div>
<div class="line">];</div>
<div class="line"> </div>
<div class="line">var parser = dashdash.createParser({options: options});</div>
<div class="line">try {</div>
<div class="line">    var opts = parser.parse(process.argv);</div>
<div class="line">} catch (e) {</div>
<div class="line">    console.error(&#39;foo: error: %s&#39;, e.message);</div>
<div class="line">    process.exit(1);</div>
<div class="line">}</div>
<div class="line"> </div>
<div class="line">console.log(&quot;# opts:&quot;, opts);</div>
<div class="line">console.log(&quot;# args:&quot;, opts._args);</div>
<div class="line"> </div>
<div class="line">// Use `parser.help()` for formatted options help.</div>
<div class="line">if (opts.help) {</div>
<div class="line">    var help = parser.help({includeEnv: true}).trimRight();</div>
<div class="line">    console.log(&#39;usage: node foo.js [OPTIONS]\n&#39;</div>
...
<div class="line"> </div>
<div class="line">// ...</div>
</div><!-- fragment --><p>Some example output from this script (foo.js):</p>
<div class="fragment"><div class="line">$ node foo.js -h</div>
<div class="line"># opts: { help: true,</div>
<div class="line">  _order: [ { name: &#39;help&#39;, value: true, from: &#39;argv&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
<div class="line">usage: node foo.js [OPTIONS]</div>
<div class="line">options:</div>
<div class="line">    --version             Print tool version and exit.</div>
<div class="line">    -h, --help            Print this help and exit.</div>
<div class="line">    -v, --verbose         Verbose output. Use multiple times for more verbose.</div>
<div class="line">    -f FILE, --file=FILE  File to process</div>
<div class="line"> </div>
<div class="line">$ node foo.js -v</div>
<div class="line"># opts: { verbose: [ true ],</div>
<div class="line">  _order: [ { name: &#39;verbose&#39;, value: true, from: &#39;argv&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
<div class="line"> </div>
<div class="line">$ node foo.js --version arg1</div>
<div class="line"># opts: { version: true,</div>
<div class="line">  _order: [ { name: &#39;version&#39;, value: true, from: &#39;argv&#39; } ],</div>
<div class="line">  _args: [ &#39;arg1&#39; ] }</div>
<div class="line"># args: [ &#39;arg1&#39; ]</div>
<div class="line"> </div>
<div class="line">$ node foo.js -f bar.txt</div>
<div class="line"># opts: { file: &#39;bar.txt&#39;,</div>
<div class="line">  _order: [ { name: &#39;file&#39;, value: &#39;bar.txt&#39;, from: &#39;argv&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
<div class="line"> </div>
<div class="line">$ node foo.js -vvv --file=blah</div>
<div class="line"># opts: { verbose: [ true, true, true ],</div>
<div class="line">  file: &#39;blah&#39;,</div>
<div class="line">  _order:</div>
<div class="line">   [ { name: &#39;verbose&#39;, value: true, from: &#39;argv&#39; },</div>
<div class="line">     { name: &#39;verbose&#39;, value: true, from: &#39;argv&#39; },</div>
<div class="line">     { name: &#39;verbose&#39;, value: true, from: &#39;argv&#39; },</div>
<div class="line">     { name: &#39;file&#39;, value: &#39;blah&#39;, from: &#39;argv&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
</div><!-- fragment --><p>See the <a href="examples/">"examples"</a> dir for a number of starter examples using some of dashdash's features.</p>
<h1><a class="anchor" id="autotoc_md6344"></a>
Environment variable integration</h1>
...
<div class="line">    names: [&#39;verbose&#39;, &#39;v&#39;],</div>
<div class="line">    type: &#39;arrayOfBool&#39;,</div>
<div class="line">    env: &#39;FOO_VERBOSE&#39;,         // &lt;--- add this line</div>
<div class="line">    help: &#39;Verbose output. Use multiple times for more verbose.&#39;</div>
<div class="line">},</div>
</div><!-- fragment --><p>then the **"FOO_VERBOSE" environment variable** can be used to set this option:</p>
<div class="fragment"><div class="line">$ FOO_VERBOSE=1 node foo.js</div>
<div class="line"># opts: { verbose: [ true ],</div>
<div class="line">  _order: [ { name: &#39;verbose&#39;, value: true, from: &#39;env&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
</div><!-- fragment --><p>Boolean options will interpret the empty string as unset, '0' as false and anything else as true.</p>
<div class="fragment"><div class="line">$ FOO_VERBOSE= node examples/foo.js                 # not set</div>
<div class="line"># opts: { _order: [], _args: [] }</div>
<div class="line"># args: []</div>
<div class="line"> </div>
<div class="line">$ FOO_VERBOSE=0 node examples/foo.js                # &#39;0&#39; is false</div>
<div class="line"># opts: { verbose: [ false ],</div>
<div class="line">  _order: [ { key: &#39;verbose&#39;, value: false, from: &#39;env&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
<div class="line"> </div>
<div class="line">$ FOO_VERBOSE=1 node examples/foo.js                # true</div>
<div class="line"># opts: { verbose: [ true ],</div>
<div class="line">  _order: [ { key: &#39;verbose&#39;, value: true, from: &#39;env&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
<div class="line"> </div>
<div class="line">$ FOO_VERBOSE=boogabooga node examples/foo.js       # true</div>
<div class="line"># opts: { verbose: [ true ],</div>
<div class="line">  _order: [ { key: &#39;verbose&#39;, value: true, from: &#39;env&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
</div><!-- fragment --><p>Non-booleans can be used as well. Strings:</p>
<div class="fragment"><div class="line">$ FOO_FILE=data.txt node examples/foo.js</div>
<div class="line"># opts: { file: &#39;data.txt&#39;,</div>
<div class="line">  _order: [ { key: &#39;file&#39;, value: &#39;data.txt&#39;, from: &#39;env&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
</div><!-- fragment --><p>Numbers:</p>
<div class="fragment"><div class="line">$ FOO_TIMEOUT=5000 node examples/foo.js</div>
<div class="line"># opts: { timeout: 5000,</div>
<div class="line">  _order: [ { key: &#39;timeout&#39;, value: 5000, from: &#39;env&#39; } ],</div>
<div class="line">  _args: [] }</div>
<div class="line"># args: []</div>
<div class="line"> </div>
<div class="line">$ FOO_TIMEOUT=blarg node examples/foo.js</div>
<div class="line">foo: error: arg for &quot;FOO_TIMEOUT&quot; is not a positive integer: &quot;blarg&quot;</div>
</div><!-- fragment --><p>With the <code>includeEnv: true</code> config to <code>parser.help()</code> the environment variable can also be included in <b>help output</b>: </p><pre class="fragment">usage: node foo.js [OPTIONS]
options:
...
</pre><h1><a class="anchor" id="autotoc_md6345"></a>
Bash completion</h1>
...
<div class="fragment"><div class="line">{</div>
<div class="line">    names: [&#39;file&#39;, &#39;f&#39;],       // Required (one of `names` or `name`).</div>
<div class="line">    type: &#39;string&#39;,             // Required.</div>
<div class="line">    completionType: &#39;filename&#39;,</div>
<div class="line">    env: &#39;MYTOOL_FILE&#39;,</div>
<div class="line">    help: &#39;Config file to load before running &quot;mytool&quot;&#39;,</div>
<div class="line">    helpArg: &#39;PATH&#39;,</div>
<div class="line">    helpWrap: false,</div>
<div class="line">    default: path.resolve(process.env.HOME, &#39;.mytoolrc&#39;)</div>
<div class="line">}</div>
</div><!-- fragment --><p>Each option spec in the <code>options</code> array must/can have the following fields:</p>
<ul>
...
<div class="line">    {</div>
<div class="line">        group: &#39;Armament Options&#39;</div>
<div class="line">    },</div>
<div class="line">    {</div>
<div class="line">        names: [ &#39;weapon&#39;, &#39;w&#39; ],</div>
<div class="line">        type: &#39;string&#39;</div>
<div class="line">    },</div>
<div class="line">    {</div>
<div class="line">        group: &#39;General Options&#39;</div>
<div class="line">    },</div>
<div class="line">    {</div>
<div class="line">        names: [ &#39;help&#39;, &#39;h&#39; ],</div>
<div class="line">        type: &#39;bool&#39;</div>
...
<div class="line">];</div>
<div class="line">...</div>
</div><!-- fragment --><p>Note: You can use an empty string, &lsquo;{group: &rsquo;'}`, to get a blank line in help output between groups of options.</p>
