...
<div class="contents">
<div class="textblock"><h1><a class="anchor" id="autotoc_md10386"></a>
...
<ol type="1">
<li>Client -(bind)-&gt; <a class="el" href="classProxy.html" title="Do nothing but invoke all child nodes Since the node is not actually &quot;no operation&quot;,...">Proxy</a> (Tells the proxy to bind to a new port)</li>
<li>Client &lt;-(port)- <a class="el" href="classProxy.html" title="Do nothing but invoke all child nodes Since the node is not actually &quot;no operation&quot;,...">Proxy</a> (Tells the origin client which port it opened)</li>
<li>Client2 --&gt; <a class="el" href="classProxy.html" title="Do nothing but invoke all child nodes Since the node is not actually &quot;no operation&quot;,...">Proxy</a> (Other client connects to the proxy on this port)</li>
<li>Client &lt;&ndash;(client2's host info) (<a class="el" href="classProxy.html" title="Do nothing but invoke all child nodes Since the node is not actually &quot;no operation&quot;,...">Proxy</a> tells the origin client who connected to it)</li>
<li>Original connection to the proxy is now a full TCP stream between client (you) and client2.</li>
<li>Client &lt;--&gt; <a class="el" href="classProxy.html" title="Do nothing but invoke all child nodes Since the node is not actually &quot;no operation&quot;,...">Proxy</a> &lt;--&gt; Client2</li>
</ol>
