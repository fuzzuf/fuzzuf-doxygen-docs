...
<p><img src="https://secure.travis-ci.org/dominictarr/JSONStream.png?branch=master" alt="" class="inline"/></p>
...
<div class="line">  , JSONStream = require(&#39;JSONStream&#39;)</div>
<div class="line">  , es = require(&#39;event-stream&#39;)</div>
<div class="line"> </div>
<div class="line">request({url: &#39;http://isaacs.couchone.com/registry/_all_docs&#39;})</div>
<div class="line">  .pipe(JSONStream.parse(&#39;rows.*&#39;))</div>
<div class="line">  .pipe(es.mapSync(function (data) {</div>
<div class="line">    console.error(data)</div>
<div class="line">    return data</div>
<div class="line">  }))</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md7760"></a>
JSONStream.parse(path)</h1>
<p>parse stream of values that match a path</p>
<div class="fragment"><div class="line">JSONStream.parse(&#39;rows.*.doc&#39;)</div>
</div><!-- fragment --><p>The <code>..</code> operator is the recursive descent operator from <a href="http://goessner.net/articles/JsonPath/">JSONPath</a>, which will match a child at any depth (see examples below).</p>
...
<div class="fragment"><div class="line">curl -sS localhost:5984/tests/_all_docs&amp;include_docs=true</div>
</div><!-- fragment --><p>you will get something like this:</p>
<div class="fragment"><div class="line">{&quot;total_rows&quot;:129,&quot;offset&quot;:0,&quot;rows&quot;:[</div>
<div class="line">  { &quot;id&quot;:&quot;change1_0.6995461115147918&quot;</div>
<div class="line">  , &quot;key&quot;:&quot;change1_0.6995461115147918&quot;</div>
<div class="line">  , &quot;value&quot;:{&quot;rev&quot;:&quot;1-e240bae28c7bb3667f02760f6398d508&quot;}</div>
<div class="line">  , &quot;doc&quot;:{</div>
<div class="line">      &quot;_id&quot;:  &quot;change1_0.6995461115147918&quot;</div>
<div class="line">    , &quot;_rev&quot;: &quot;1-e240bae28c7bb3667f02760f6398d508&quot;,&quot;hello&quot;:1}</div>
<div class="line">  },</div>
<div class="line">  { &quot;id&quot;:&quot;change2_0.6995461115147918&quot;</div>
<div class="line">  , &quot;key&quot;:&quot;change2_0.6995461115147918&quot;</div>
<div class="line">  , &quot;value&quot;:{&quot;rev&quot;:&quot;1-13677d36b98c0c075145bb8975105153&quot;}</div>
<div class="line">  , &quot;doc&quot;:{</div>
<div class="line">      &quot;_id&quot;:&quot;change2_0.6995461115147918&quot;</div>
<div class="line">    , &quot;_rev&quot;:&quot;1-13677d36b98c0c075145bb8975105153&quot;</div>
<div class="line">    , &quot;hello&quot;:2</div>
<div class="line">    }</div>
<div class="line">  },</div>
<div class="line">]}</div>
</div><!-- fragment --><p>we are probably most interested in the <code>rows.*.doc</code></p>
<p>create a <code>Stream</code> that parses the documents from the feed like this:</p>
<div class="fragment"><div class="line">var stream = JSONStream.parse([&#39;rows&#39;, true, &#39;doc&#39;]) //rows, ANYTHING, doc</div>
<div class="line"> </div>
<div class="line">stream.on(&#39;data&#39;, function(data) {</div>
<div class="line">  console.log(&#39;received:&#39;, data);</div>
<div class="line">});</div>
<div class="line">//emits anything from _before_ the first match</div>
<div class="line">stream.on(&#39;header&#39;, function (data) {</div>
<div class="line">  console.log(&#39;header:&#39;, data) // =&gt; {&quot;total_rows&quot;:129,&quot;offset&quot;:0}</div>
<div class="line">})</div>
</div><!-- fragment --><p>awesome!</p>
<p>In case you wanted the contents the doc emitted:</p>
<div class="fragment"><div class="line">var stream = JSONStream.parse([&#39;rows&#39;, true, &#39;doc&#39;, {emitKey: true}]) //rows, ANYTHING, doc, items in docs with keys</div>
<div class="line"> </div>
<div class="line">stream.on(&#39;data&#39;, function(data) {</div>
<div class="line">  console.log(&#39;key:&#39;, data.key);</div>
<div class="line">  console.log(&#39;value:&#39;, data.value);</div>
<div class="line">});</div>
</div><!-- fragment --><p>You can also emit the path:</p>
<div class="fragment"><div class="line">var stream = JSONStream.parse([&#39;rows&#39;, true, &#39;doc&#39;, {emitPath: true}]) //rows, ANYTHING, doc, items in docs with keys</div>
<div class="line"> </div>
<div class="line">stream.on(&#39;data&#39;, function(data) {</div>
<div class="line">  console.log(&#39;path:&#39;, data.path);</div>
<div class="line">  console.log(&#39;value:&#39;, data.value);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md7762"></a>
...
<div class="line">        &quot;some&quot;: &quot;property&quot;</div>
<div class="line">      }</div>
<div class="line">    },</div>
<div class="line">    {&quot;value&quot;: 1},</div>
<div class="line">    {&quot;value&quot;: 2},</div>
<div class="line">    {&quot;blbl&quot;: [{}, {&quot;a&quot;:0, &quot;b&quot;:1, &quot;value&quot;:3}, 10]},</div>
<div class="line">    {&quot;value&quot;: 4}</div>
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md7763"></a>
JSONStream.parse(pattern, map)</h1>
...
JSONStream.stringify(open, sep, close)</h1>
...
JSONStream.stringifyObject(open, sep, close)</h1>
...
<div class="fragment"><div class="line">curl https://registry.npmjs.org/browserify | JSONStream &#39;versions.*.dependencies&#39;</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md7767"></a>
numbers</h1>
