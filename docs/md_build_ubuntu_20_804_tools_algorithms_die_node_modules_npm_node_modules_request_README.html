...
<title>fuzzuf: Request - Simplified HTTP client</title>
...
<div class="contents">
<div class="textblock"><p><a href="https://nodei.co/npm/request/"><img src="https://nodei.co/npm/request.png?downloads=true&amp;downloadRank=true&amp;stars=true" alt="npm package" class="inline"/></a></p>
<p><a href="https://travis-ci.org/request/request"><object type="image/svg+xml" data="https://img.shields.io/travis/request/request/master.svg?style=flat-square" style="pointer-events: none;">Build status</object></a> <a href="https://codecov.io/github/request/request?branch=master"><object type="image/svg+xml" data="https://img.shields.io/codecov/c/github/request/request.svg?style=flat-square" style="pointer-events: none;">Coverage</object></a> <a href="https://coveralls.io/r/request/request"><object type="image/svg+xml" data="https://img.shields.io/coveralls/request/request.svg?style=flat-square" style="pointer-events: none;">Coverage</object></a> <a href="https://david-dm.org/request/request"><object type="image/svg+xml" data="https://img.shields.io/david/request/request.svg?style=flat-square" style="pointer-events: none;">Dependency Status</object></a> <a href="https://snyk.io/test/npm/request"><object type="image/svg+xml" data="https://snyk.io/test/npm/request/badge.svg?style=flat-square" style="pointer-events: none;">Known Vulnerabilities</object></a> <a href="https://gitter.im/request/request?utm_source=badge"><object type="image/svg+xml" data="https://img.shields.io/badge/gitter-join_chat-blue.svg?style=flat-square" style="pointer-events: none;">Gitter</object></a></p>
...
<div class="line">  console.log(&#39;error:&#39;, error); // Print the error if one occurred</div>
...
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10515"></a>
...
</div><!-- fragment --><p>Request emits a "response" event when a response is received. The <code>response</code> argument will be an instance of <a href="https://nodejs.org/api/http.html#http_class_http_incomingmessage">http.IncomingMessage</a>.</p>
...
</div><!-- fragment --><p>To easily handle errors when streaming requests, listen to the <code>error</code> event before piping:</p>
<div class="fragment"><div class="line">request</div>
...
<div class="fragment"><div class="line">http.createServer(function (req, resp) {</div>
<div class="line">  if (req.url === &#39;/doodle.png&#39;) {</div>
<div class="line">    var x = request(&#39;http://mysite.com/doodle.png&#39;)</div>
...
<div class="fragment"><div class="line">var r = request.defaults({&#39;proxy&#39;:&#39;http://localproxy.com&#39;})</div>
<div class="line"> </div>
...
<p><a href="#table-of-contents">back to top</a></p>
<hr  />
<h1><a class="anchor" id="autotoc_md10521"></a>
Forms</h1>
...
<h3><a class="anchor" id="autotoc_md10522"></a>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md10523"></a>
...
<div class="line">});</div>
</div><!-- fragment --><p>For advanced cases, you can access the form-data object itself via <code>r.form()</code>. This can be modified until the request is fired on the next cycle of the event-loop. (Note that this calling <code>form()</code> will clear the currently set form data for that request.)</p>
<div class="fragment"><div class="line">// NOTE: Advanced use-case, for normal use see &#39;formData&#39; usage above</div>
<div class="line">var r = request.post(&#39;http://service.com/upload&#39;, function optionalCallback(err, httpResponse, body) {...})</div>
<div class="line">var form = r.form();</div>
...
<h3><a class="anchor" id="autotoc_md10524"></a>
...
<div class="line">  console.log(&#39;Upload successful!  Server responded with:&#39;, body);</div>
<div class="line">})</div>
</div><!-- fragment --><p><a href="#table-of-contents">back to top</a></p>
<hr  />
<h1><a class="anchor" id="autotoc_md10526"></a>
...
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><p>If passed as an option, <code>auth</code> should be a hash containing values:</p>
<ul>
...
<div class="fragment"><div class="line">var username = &#39;username&#39;,</div>
<div class="line">    password = &#39;password&#39;,</div>
<div class="line">    url = &#39;http://&#39; + username + &#39;:&#39; + password + &#39;@some.server.com&#39;;</div>
<div class="line"> </div>
<div class="line">request({url: url}, function (error, response, body) {</div>
...
<div class="line">  url: &#39;https://api.github.com/repos/request/request&#39;,</div>
...
<div class="line">    var info = JSON.parse(body);</div>
...
<div class="fragment"><div class="line">// OAuth1.0 - 3-legged server side flow (Twitter example)</div>
<div class="line">// step 1</div>
<div class="line">var qs = require(&#39;querystring&#39;)</div>
<div class="line">  , oauth =</div>
<div class="line">    { callback: &#39;http://mysite.com/callback/&#39;</div>
<div class="line">    , consumer_key: CONSUMER_KEY</div>
<div class="line">    , consumer_secret: CONSUMER_SECRET</div>
<div class="line">    }</div>
<div class="line">  , url = &#39;https://api.twitter.com/oauth/request_token&#39;</div>
<div class="line">  ;</div>
<div class="line">request.post({url:url, oauth:oauth}, function (e, r, body) {</div>
<div class="line">  // Ideally, you would take the body in the response</div>
<div class="line">  // and construct a URL that a user clicks on (like a sign in button).</div>
<div class="line">  // The verifier is only available in the response after a user has</div>
<div class="line">  // verified with twitter that they are authorizing your app.</div>
<div class="line"> </div>
<div class="line">  // step 2</div>
<div class="line">  var req_data = qs.parse(body)</div>
<div class="line">  var uri = &#39;https://api.twitter.com/oauth/authenticate&#39;</div>
<div class="line">    + &#39;?&#39; + qs.stringify({oauth_token: req_data.oauth_token})</div>
<div class="line">  // redirect the user to the authorize uri</div>
<div class="line"> </div>
<div class="line">  // step 3</div>
<div class="line">  // after the user is redirected back to your server</div>
<div class="line">  var auth_data = qs.parse(body)</div>
<div class="line">    , oauth =</div>
<div class="line">      { consumer_key: CONSUMER_KEY</div>
<div class="line">      , consumer_secret: CONSUMER_SECRET</div>
<div class="line">      , token: auth_data.oauth_token</div>
<div class="line">      , token_secret: req_data.oauth_token_secret</div>
<div class="line">      , verifier: auth_data.oauth_verifier</div>
<div class="line">      }</div>
<div class="line">    , url = &#39;https://api.twitter.com/oauth/access_token&#39;</div>
<div class="line">    ;</div>
<div class="line">  request.post({url:url, oauth:oauth}, function (e, r, body) {</div>
<div class="line">    // ready to make signed requests on behalf of the user</div>
<div class="line">    var perm_data = qs.parse(body)</div>
<div class="line">      , oauth =</div>
<div class="line">        { consumer_key: CONSUMER_KEY</div>
<div class="line">        , consumer_secret: CONSUMER_SECRET</div>
<div class="line">        , token: perm_data.oauth_token</div>
<div class="line">        , token_secret: perm_data.oauth_token_secret</div>
<div class="line">        }</div>
<div class="line">      , url = &#39;https://api.twitter.com/1.1/users/show.json&#39;</div>
<div class="line">      , qs =</div>
<div class="line">        { screen_name: perm_data.screen_name</div>
<div class="line">        , user_id: perm_data.user_id</div>
<div class="line">        }</div>
<div class="line">      ;</div>
<div class="line">    request.get({url:url, oauth:oauth, qs:qs, json:true}, function (e, r, user) {</div>
<div class="line">      console.log(user)</div>
<div class="line">    })</div>
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><p>For <a href="https://tools.ietf.org/html/rfc5849#section-3.4.3">RSA-SHA1 signing</a>, make the following changes to the OAuth options object:</p><ul>
...
</div><!-- fragment --><p>Note that, when using a tunneling proxy, the <code>proxy-authorization</code> header and any headers from custom <code>proxyHeaderExclusiveList</code> are <em>never</em> sent to the endpoint server, but only to the proxy server.</p>
<h2><a class="anchor" id="autotoc_md10533"></a>
...
</div><!-- fragment --><p>Note: The <code>SOCKET</code> path is assumed to be absolute to the root of the host file system.</p>
<p><a href="#table-of-contents">back to top</a></p>
<hr  />
<h1><a class="anchor" id="autotoc_md10537"></a>
TLS/SSL Protocol</h1>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10538"></a>
Using &lt;tt&gt;options.agentOptions&lt;/tt&gt;</h2>
...
<div class="line"> </div>
<div class="line">request.get(options);</div>
</div><!-- fragment --><p>It is able to force using SSLv3 only by specifying <code>secureProtocol</code>:</p>
...
<hr  />
<h1><a class="anchor" id="autotoc_md10540"></a>
...
<li><code>removeRefererHeader</code> - removes the referer header when a redirect happens (default: <code>false</code>). <b>Note:</b> if true, referer header set in the initial request is preserved during redirect chain.</li>
</ul>
<hr  />
<ul>
...
<div class="line">var baseRequest = request.defaults({</div>
...
<div class="line">var specialRequest = baseRequest.defaults({</div>
<div class="line">  headers: {special: &#39;special value&#39;}</div>
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10554"></a>
request.METHOD()</h2>
...
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10561"></a>
Examples:</h1>
<div class="fragment"><div class="line">var request = require(&#39;request&#39;)</div>
...
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><p>Cookies are disabled by default (else, they would be used in subsequent requests). To enable cookies, set <code>jar</code> to <code>true</code> (either in <code>defaults</code> or <code>options</code>).</p>
<div class="fragment"><div class="line">var request = request.defaults({jar: true})</div>
...
<div class="fragment"><div class="line">var j = request.jar()</div>
<div class="line">var request = request.defaults({jar:j})</div>
<div class="line">request(&#39;http://www.google.com&#39;, function () {</div>
<div class="line">  request(&#39;http://images.google.com&#39;)</div>
<div class="line">})</div>
</div><!-- fragment --><p>OR</p>
<div class="fragment"><div class="line">var j = request.jar();</div>
<div class="line">var cookie = request.cookie(&#39;key1=value1&#39;);</div>
<div class="line">var url = &#39;http://www.google.com&#39;;</div>
<div class="line">j.setCookie(cookie, url);</div>
<div class="line">request({url: url, jar: j}, function () {</div>
<div class="line">  request(&#39;http://images.google.com&#39;)</div>
<div class="line">})</div>
</div><!-- fragment --><p>To use a custom cookie store (such as a <a href="https://github.com/mitsuru/tough-cookie-filestore"><code>FileCookieStore</code></a> which supports saving to and restoring from JSON files), pass it as a parameter to <code>request.jar()</code>:</p>
<div class="fragment"><div class="line">var FileCookieStore = require(&#39;tough-cookie-filestore&#39;);</div>
<div class="line">// NOTE - currently the &#39;cookies.json&#39; file must already exist!</div>
<div class="line">var j = request.jar(new FileCookieStore(&#39;cookies.json&#39;));</div>
<div class="line">request = request.defaults({ jar : j })</div>
<div class="line">request(&#39;http://www.google.com&#39;, function() {</div>
<div class="line">  request(&#39;http://images.google.com&#39;)</div>
<div class="line">})</div>
</div><!-- fragment --><p>The cookie store must be a <a href="https://github.com/SalesforceEng/tough-cookie"><code>tough-cookie</code></a> store and it must support synchronous operations; see the <a href="https://github.com/SalesforceEng/tough-cookie#cookiestore-api"><code>CookieStore</code> API docs</a> for details.</p>
<p>To inspect your cookie jar after a request:</p>
<div class="fragment"><div class="line">var j = request.jar()</div>
<div class="line">request({url: &#39;http://www.google.com&#39;, jar: j}, function () {</div>
<div class="line">  var cookie_string = j.getCookieString(url); // &quot;key1=value1; key2=value2; ...&quot;</div>
<div class="line">  var cookies = j.getCookies(url);</div>
