...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md6253"></a>
Usage:</h1>
...
<h1><a class="anchor" id="autotoc_md6255"></a>
API</h1>
<ul>
...
<p class="startli"><a class="el" href="classClear.html" title="call clear() member function of the value specified by the Path. The node takes 1 path for value to c...">Clear</a> the cache entirely, throwing away all values.</p>
</li>
