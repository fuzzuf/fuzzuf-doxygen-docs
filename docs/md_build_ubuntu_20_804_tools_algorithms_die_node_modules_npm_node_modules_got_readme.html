...
<div class="textblock"><h1 align="center"><br  />
 <object type="image/svg+xml" data="https://rawgit.com/sindresorhus/got/master/media/logo.svg" style="pointer-events: none;" width="360">got</object> <br  />
 <br  />
 <br  />
 </h1>
...
<p><a href="https://travis-ci.org/sindresorhus/got"><object type="image/svg+xml" data="https://travis-ci.org/sindresorhus/got.svg?branch=master" style="pointer-events: none;">Build Status</object></a> <a href="https://coveralls.io/github/sindresorhus/got?branch=master"><object type="image/svg+xml" data="https://coveralls.io/repos/github/sindresorhus/got/badge.svg?branch=master" style="pointer-events: none;">Coverage Status</object></a> <a href="https://npmjs.com/got"><object type="image/svg+xml" data="https://img.shields.io/npm/dm/got.svg" style="pointer-events: none;">Downloads</object></a></p>
...
<p>Created because <a href="https://github.com/request/request"><code>request</code></a> is bloated *(several megabytes!)*.</p>
<h2><a class="anchor" id="autotoc_md6705"></a>
Install</h2>
<p>**WARNING: Node.js 4 or higher is required for got@6 and above.** For older Node.js versions use <a href="https://github.com/sindresorhus/got/tree/v5.x">got@5</a>.</p>
<div class="fragment"><div class="line">$ npm install --save got</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md6706"></a>
Usage</h2>
<div class="fragment"><div class="line">const fs = require(&#39;fs&#39;);</div>
<div class="line">const got = require(&#39;got&#39;);</div>
<div class="line"> </div>
<div class="line">got(&#39;todomvc.com&#39;)</div>
<div class="line">    .then(response =&gt; {</div>
<div class="line">        console.log(response.body);</div>
<div class="line">        //=&gt; &#39;&lt;!doctype html&gt; ...&#39;</div>
<div class="line">    })</div>
<div class="line">    .catch(error =&gt; {</div>
<div class="line">        console.log(error.response.body);</div>
<div class="line">        //=&gt; &#39;Internal server error ...&#39;</div>
<div class="line">    });</div>
<div class="line"> </div>
<div class="line">// Streams</div>
<div class="line">got.stream(&#39;todomvc.com&#39;).pipe(fs.createWriteStream(&#39;index.html&#39;));</div>
<div class="line"> </div>
<div class="line">// For POST, PUT and PATCH methods got.stream returns a WritableStream</div>
<div class="line">fs.createReadStream(&#39;index.html&#39;).pipe(got.stream.post(&#39;todomvc.com&#39;));</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md6707"></a>
API</h3>
<p>It's a <code>GET</code> request by default, but can be changed in <code>options</code>.</p>
<h4><a class="anchor" id="autotoc_md6708"></a>
got(url, [options])</h4>
...
<p><a class="anchor" id="autotoc_md6709"></a></p><h5>url</h5>
...
<p><a class="anchor" id="autotoc_md6710"></a></p><h5>options</h5>
...
<h4><a class="anchor" id="autotoc_md6711"></a>
Streams</h4>
<h4><a class="anchor" id="autotoc_md6712"></a>
got.stream(url, [options])</h4>
<p><code>stream</code> method will return Duplex stream with additional events:</p>
<p><a class="anchor" id="autotoc_md6713"></a></p><h5>.on('request', request)</h5>
...
<div class="fragment"><div class="line">got.stream(&#39;github.com&#39;)</div>
<div class="line">    .on(&#39;request&#39;, req =&gt; setTimeout(() =&gt; req.abort(), 50));</div>
</div><!-- fragment --><p><a class="anchor" id="autotoc_md6714"></a></p><h5>.on('response', response)</h5>
<p><code>response</code> event to get the response object of the final request.</p>
<p><a class="anchor" id="autotoc_md6715"></a></p><h5>.on('redirect', response, nextOptions)</h5>
...
<p><a class="anchor" id="autotoc_md6716"></a></p><h5>.on('error', error, body, response)</h5>
...
<h4><a class="anchor" id="autotoc_md6717"></a>
got.get(url, [options])</h4>
<h4><a class="anchor" id="autotoc_md6718"></a>
got.post(url, [options])</h4>
<h4><a class="anchor" id="autotoc_md6719"></a>
got.put(url, [options])</h4>
<h4><a class="anchor" id="autotoc_md6720"></a>
got.patch(url, [options])</h4>
<h4><a class="anchor" id="autotoc_md6721"></a>
got.head(url, [options])</h4>
<h4><a class="anchor" id="autotoc_md6722"></a>
got.delete(url, [options])</h4>
...
<div class="fragment"><div class="line">const got = require(&#39;got&#39;);</div>
<div class="line">const tunnel = require(&#39;tunnel&#39;);</div>
<div class="line"> </div>
<div class="line">got(&#39;todomvc.com&#39;, {</div>
<div class="line">    agent: tunnel.httpOverHttp({</div>
...
<div class="fragment"><div class="line">const got = require(&#39;got&#39;);</div>
<div class="line">const cookie = require(&#39;cookie&#39;);</div>
<div class="line"> </div>
<div class="line">got(&#39;google.com&#39;, {</div>
<div class="line">    headers: {</div>
<div class="line">        cookie: cookie.serialize(&#39;foo&#39;, &#39;bar&#39;)</div>
<div class="line">    }</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md6731"></a>
Form data</h2>
...
<div class="fragment"><div class="line">const got = require(&#39;got&#39;);</div>
<div class="line">const crypto  = require(&#39;crypto&#39;);</div>
<div class="line">const OAuth = require(&#39;oauth-1.0a&#39;);</div>
<div class="line"> </div>
<div class="line">const oauth = OAuth({</div>
<div class="line">    consumer: {</div>
<div class="line">        key: process.env.CONSUMER_KEY,</div>
<div class="line">        secret: process.env.CONSUMER_SECRET</div>
<div class="line">    },</div>
<div class="line">    signature_method: &#39;HMAC-SHA1&#39;,</div>
<div class="line">    hash_function: (baseString, key) =&gt; crypto.createHmac(&#39;sha1&#39;, key).update(baseString).digest(&#39;base64&#39;)</div>
<div class="line">});</div>
<div class="line"> </div>
<div class="line">const token = {</div>
<div class="line">    key: process.env.ACCESS_TOKEN,</div>
<div class="line">    secret: process.env.ACCESS_TOKEN_SECRET</div>
<div class="line">};</div>
<div class="line"> </div>
<div class="line">const url = &#39;https://api.twitter.com/1.1/statuses/home_timeline.json&#39;;</div>
<div class="line"> </div>
<div class="line">got(url, {</div>
<div class="line">    headers: oauth.toHeader(oauth.authorize({url, method: &#39;GET&#39;}, token)),</div>
<div class="line">    json: true</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md6733"></a>
...
<div class="fragment"><div class="line">got(&#39;http://unix:/var/run/docker.sock:/containers/json&#39;);</div>
<div class="line"> </div>
<div class="line">// or without protocol (http by default)</div>
<div class="line">got(&#39;unix:/var/run/docker.sock:/containers/json&#39;);</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md6734"></a>
Tip</h2>
<p>It's a good idea to set the &lsquo;'user-agent&rsquo;` header so the provider can more easily see how their resource is used. By default, it's the URL to this repo.</p>
<p>``&lsquo;js const got = require('got&rsquo;); const pkg = require('./package.json');</p>
<p>got('todomvc.com', { headers: { 'user-agent': <code>my-module/${pkg.version} (<a href="https://github.com/username/my-module">https://github.com/username/my-module</a>)</code> } }); ```</p>
<h2><a class="anchor" id="autotoc_md6735"></a>
Related</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md6736"></a>
Created by</h2>
<table class="markdownTable">
<tr class="markdownTableHead">
<th class="markdownTableHeadNone"><a href="https://sindresorhus.com"><img src="https://avatars.githubusercontent.com/u/170270?v=3&amp;s=100" alt="Sindre Sorhus" class="inline"/></a> </th><th class="markdownTableHeadNone"><a href="https://github.com/floatdrop"><img src="https://avatars.githubusercontent.com/u/365089?v=3&amp;s=100" alt="Vsevolod Strukchinsky" class="inline"/></a>  </th></tr>
<tr class="markdownTableRowOdd">
<td class="markdownTableBodyNone"><a href="https://sindresorhus.com">Sindre Sorhus</a> </td><td class="markdownTableBodyNone"><a href="https://github.com/floatdrop">Vsevolod Strukchinsky</a>  </td></tr>
</table>
<h2><a class="anchor" id="autotoc_md6737"></a>
License</h2>
