...
<title>fuzzuf: make-fetch-happen &lt;a href=&quot;https://npm.im/make-fetch-happen&quot;&gt;&lt;img src=&quot;https://img.shields.io/npm/v/make-fetch-happen.svg&quot; alt=&quot;npm version&quot;/&gt;&lt;/a&gt; &lt;a href=&quot;https://npm.im/make-fetch-happen&quot;&gt;&lt;img src=&quot;https://img.shields.io/npm/l/make-fetch-happen.svg&quot; alt=&quot;license&quot;/&gt;&lt;/a&gt; &lt;a href=&quot;https://travis-ci.org/zkat/make-fetch-happen&quot;&gt;&lt;img src=&quot;https://img.shields.io/travis/zkat/make-fetch-happen.svg&quot; alt=&quot;Travis&quot;/&gt;&lt;/a&gt; &lt;a href=&quot;https://ci.appveyor.com/project/zkat/make-fetch-happen&quot;&gt;&lt;img src=&quot;https://ci.appveyor.com/api/projects/status/github/zkat/make-fetch-happen?svg=true&quot; alt=&quot;AppVeyor&quot;/&gt;&lt;/a&gt; &lt;a href=&quot;https://coveralls.io/github/zkat/make-fetch-happen?branch=latest&quot;&gt;&lt;img src=&quot;https://coveralls.io/repos/github/zkat/make-fetch-happen/badge.svg?branch=latest&quot; alt=&quot;Coverage Status&quot;/&gt;&lt;/a&gt;</title>
...
<div class="title">make-fetch-happen <a href="https://npm.im/make-fetch-happen"><object type="image/svg+xml" data="https://img.shields.io/npm/v/make-fetch-happen.svg" style="pointer-events: none;">npm version</object></a> <a href="https://npm.im/make-fetch-happen"><object type="image/svg+xml" data="https://img.shields.io/npm/l/make-fetch-happen.svg" style="pointer-events: none;">license</object></a> <a href="https://travis-ci.org/zkat/make-fetch-happen"><object type="image/svg+xml" data="https://img.shields.io/travis/zkat/make-fetch-happen.svg" style="pointer-events: none;">Travis</object></a> <a href="https://ci.appveyor.com/project/zkat/make-fetch-happen"><img src="https://ci.appveyor.com/api/projects/status/github/zkat/make-fetch-happen?svg=true" alt="AppVeyor" class="inline"/></a> <a href="https://coveralls.io/github/zkat/make-fetch-happen?branch=latest"><object type="image/svg+xml" data="https://coveralls.io/repos/github/zkat/make-fetch-happen/badge.svg?branch=latest" style="pointer-events: none;">Coverage Status</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p><a href="https://github.com/zkat/make-fetch-happen"><code>make-fetch-happen</code></a> is a Node.js library that wraps <a href="https://github.com/npm/node-fetch-npm"><code>node-fetch-npm</code></a> with additional features <a href="https://github.com/bitinn/node-fetch"><code>node-fetch</code></a> doesn't intend to include, including HTTP Cache support, request pooling, proxies, retries, <a href="#features">and more</a>!</p>
<h1><a class="anchor" id="autotoc_md8048"></a>
Install</h1>
<p><code>$ npm install --save make-fetch-happen</code></p>
<h1><a class="anchor" id="autotoc_md8049"></a>
...
<li><a href="#node-fetch-options"><code>node-fetch</code> options</a></li>
<li><a href="#extra-options"><code>make-fetch-happen</code> options</a><ul>
<li><a href="#opts-cache-manager"><code>opts.cacheManager</code></a></li>
...
<h2><a class="anchor" id="autotoc_md8050"></a>
Example</h2>
<div class="fragment"><div class="line">const fetch = require(&#39;make-fetch-happen&#39;).defaults({</div>
<div class="line">  cacheManager: &#39;./my-cache&#39; // path where cache will be written (and read)</div>
<div class="line">})</div>
<div class="line"> </div>
...
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8051"></a>
Features</h2>
<ul>
<li>Builds around <a href="https://npm.im/node-fetch"><code>node-fetch</code></a> for the core <a href="https://fetch.spec.whatwg.org"><code>fetch</code> API</a> implementation</li>
...
<li><a class="el" href="classProxy.html" title="Do nothing but invoke all child nodes Since the node is not actually &quot;no operation&quot;,...">Proxy</a> support (http, https, socks, socks4, socks5)</li>
...
<h2><a class="anchor" id="autotoc_md8052"></a>
Contributing</h2>
<p>The make-fetch-happen team enthusiastically welcomes contributions and project participation! There's a bunch of things you can do if you want to contribute! The Contributor Guide has all the information you need for everything from reporting bugs to contributing entire new features. Please don't hesitate to jump in if you'd like to, or even ask us questions if something isn't clear.</p>
<p>All participants and maintainers in this project are expected to follow Code of Conduct, and just generally be excellent to each other.</p>
<p>Please refer to the Changelog for project history details, too.</p>
<p>Happy hacking!</p>
<h2><a class="anchor" id="autotoc_md8053"></a>
API</h2>
<h3><a class="anchor" id="autotoc_md8054"></a>
&lt;a name="fetch"&gt;&lt;/a&gt; &lt;tt&gt;&gt; fetch(uriOrRequest, [opts]) -&gt; Promise&lt;Response&gt;&lt;/tt&gt;</h3>
...
<p>If <code>opts</code> is provided, the <a href="#node-fetch-options"><code>node-fetch</code>-specific options</a> will be passed to that library. There are also <a href="#extra-options">additional options</a> specific to make-fetch-happen that add various features, such as HTTP caching, integrity verification, proxy support, and more.</p>
<h4><a class="anchor" id="autotoc_md8055"></a>
Example</h4>
<div class="fragment"><div class="line">fetch(&#39;https://google.com&#39;).then(res =&gt; res.buffer())</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8056"></a>
&lt;a name="fetch-defaults"&gt;&lt;/a&gt; &lt;tt&gt;&gt; fetch.defaults([defaultUrl], [defaultOpts])&lt;/tt&gt;</h3>
...
<h4><a class="anchor" id="autotoc_md8057"></a>
Example</h4>
<div class="fragment"><div class="line">const fetch = require(&#39;make-fetch-happen&#39;).defaults({</div>
<div class="line">  cacheManager: &#39;./my-local-cache&#39;</div>
<div class="line">})</div>
<div class="line"> </div>
...
&lt;a name="node-fetch-options"&gt;&lt;/a&gt; &lt;tt&gt;&gt; node-fetch options&lt;/tt&gt;</h3>
<p>The following options for <code>node-fetch</code> are used as-is:</p>
<ul>
<li>method</li>
<li>body</li>
<li>redirect</li>
...
<p>For more details, see <a href="https://github.com/bitinn/node-fetch#options">the documentation for <code>node-fetch</code> itself</a>.</p>
<h3><a class="anchor" id="autotoc_md8059"></a>
&lt;a name="extra-options"&gt;&lt;/a&gt; &lt;tt&gt;&gt; make-fetch-happen options&lt;/tt&gt;</h3>
<p>make-fetch-happen augments the <code>node-fetch</code> API with additional features available through extra options. The following extra options are available:</p>
<ul>
<li><a href="#opts-cache-manager"><code>opts.cacheManager</code></a> - Cache target to read/write</li>
<li><a href="#opts-cache"><code>opts.cache</code></a> - <code>fetch</code> cache mode. Controls cache <em>behavior</em>.</li>
<li><a href="#opts-proxy"><code>opts.proxy</code></a> - <a class="el" href="classProxy.html" title="Do nothing but invoke all child nodes Since the node is not actually &quot;no operation&quot;,...">Proxy</a> agent</li>
...
<h3><a class="anchor" id="autotoc_md8060"></a>
&lt;a name="opts-cache-manager"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.cacheManager&lt;/tt&gt;</h3>
<p>Either a <code>String</code> or a <code>Cache</code>. If the former, it will be assumed to be a <code>Path</code> to be used as the cache root for <a href="https://npm.im/cacache"><code>cacache</code></a>.</p>
<p>If an object is provided, it will be assumed to be a compliant <a href="https://developer.mozilla.org/en-US/docs/Web/API/Cache"><code>Cache</code> instance</a>. Only <code>Cache.match()</code>, <code>Cache.put()</code>, and <code>Cache.delete()</code> are required. Options objects will not be passed in to <code>match()</code> or <code>delete()</code>.</p>
<p>By implementing this API, you can customize the storage backend for make-fetch-happen itself &ndash; for example, you could implement a cache that uses <code>redis</code> for caching, or simply keeps everything in memory. Most of the caching logic exists entirely on the make-fetch-happen side, so the only thing you need to worry about is reading, writing, and deleting, as well as making sure <code>fetch.Response</code> objects are what gets returned.</p>
<p>You can refer to <code>cache.js</code> in the make-fetch-happen source code for a reference implementation.</p>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md8061"></a>
Example</h4>
...
<div class="line"> </div>
<div class="line">fetch(&#39;https://npm.im/cacache&#39;, {</div>
<div class="line">  cacheManager: new MyCustomRedisCache(process.env.PORT)</div>
<div class="line">}) // -&gt; 200-level response will be written to redis</div>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8062"></a>
&lt;a name="opts-cache"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.cache&lt;/tt&gt;</h3>
<p>This option follows the standard <code>fetch</code> API cache option. This option will do nothing if <a href="#opts-cache-manager"><code>opts.cacheManager</code></a> is null. The following values are accepted (as strings):</p>
<ul>
...
<h4><a class="anchor" id="autotoc_md8063"></a>
Example</h4>
<div class="fragment"><div class="line">const fetch = require(&#39;make-fetch-happen&#39;).defaults({</div>
<div class="line">  cacheManager: &#39;./my-cache&#39;</div>
<div class="line">})</div>
<div class="line"> </div>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8064"></a>
&lt;a name="opts-proxy"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.proxy&lt;/tt&gt;</h3>
<p>A string or <code>url.parse</code>-d URI to proxy through. Different <a class="el" href="classProxy.html" title="Do nothing but invoke all child nodes Since the node is not actually &quot;no operation&quot;,...">Proxy</a> handlers will be used depending on the proxy's protocol.</p>
...
<h4><a class="anchor" id="autotoc_md8065"></a>
Example</h4>
<div class="fragment"><div class="line">fetch(&#39;https://registry.npmjs.org/make-fetch-happen&#39;, {</div>
...
<div class="line">  }</div>
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8066"></a>
&lt;a name="opts-no-proxy"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.noProxy&lt;/tt&gt;</h3>
...
&lt;a name="https-opts"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.ca, opts.cert, opts.key, opts.strictSSL&lt;/tt&gt;</h3>
...
&lt;a name="opts-local-address"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.localAddress&lt;/tt&gt;</h3>
...
&lt;a name="opts-max-sockets"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.maxSockets&lt;/tt&gt;</h3>
<p>Default: 15</p>
...
&lt;a name="opts-retry"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.retry&lt;/tt&gt;</h3>
...
<li><code>ECONNRESET</code> currently has no support for restarting. It will eventually be supported but requires a bit more juggling due to streaming.</li>
</ul>
...
<h4><a class="anchor" id="autotoc_md8071"></a>
Example</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8072"></a>
&lt;a name="opts-onretry"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.onRetry&lt;/tt&gt;</h3>
<p>A function called whenever a retry is attempted.</p>
<h4><a class="anchor" id="autotoc_md8073"></a>
Example</h4>
<div class="fragment"><div class="line">fetch(&#39;https://flaky.site.com&#39;, {</div>
...
<div class="line">  }</div>
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8074"></a>
&lt;a name="opts-integrity"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.integrity&lt;/tt&gt;</h3>
...
<h4><a class="anchor" id="autotoc_md8075"></a>
Example</h4>
...
&lt;a name="wow"&gt;&lt;/a&gt; Message From Our Sponsors</h2>
