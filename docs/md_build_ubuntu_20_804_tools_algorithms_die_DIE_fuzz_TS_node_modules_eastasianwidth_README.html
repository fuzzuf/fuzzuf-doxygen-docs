...
<title>fuzzuf: East Asian Width</title>
...
<div class="title">East Asian Width </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p>Get <a href="http://www.unicode.org/reports/tr11/">East Asian Width</a> from a character.</p>
...
Install</h1>
<pre class="fragment">$ npm install eastasianwidth
</pre><h1><a class="anchor" id="autotoc_md977"></a>
Usage</h1>
<pre class="fragment">var eaw = require('eastasianwidth');
