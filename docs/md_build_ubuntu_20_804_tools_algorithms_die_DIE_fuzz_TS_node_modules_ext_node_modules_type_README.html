...
<div class="contents">
<div class="textblock"><p><a href="https://github.com/medikoo/type/actions?query=workflow%3AIntegrate"><object type="image/svg+xml" data="https://github.com/medikoo/type/workflows/Integrate/badge.svg" style="pointer-events: none;">Build status</object></a> <a href="https://codecov.io/gh/medikoo/type"><object type="image/svg+xml" data="https://img.shields.io/codecov/c/github/medikoo/type.svg" style="pointer-events: none;">Tests coverage</object></a> <a href="https://www.npmjs.com/package/type"><object type="image/svg+xml" data="https://img.shields.io/npm/v/type.svg" style="pointer-events: none;">npm version</object></a></p>
...
<h3><a class="anchor" id="autotoc_md1701"></a>
Example usage</h3>
...
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1702"></a>
Installation</h3>
<div class="fragment"><div class="line">npm install type</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md1703"></a>
Utilities</h2>
<p>Aside of general `ensure` validation util, following kind of utilities for recognized JavaScript types are provided:</p>
<p><a class="anchor" id="autotoc_md1704"></a></p><h5><code>*/coerce</code></h5>
<p>Restricted coercion into primitive type. Returns coerced value or <code>null</code> if value is not coercible per rules.</p>
<p><a class="anchor" id="autotoc_md1705"></a></p><h5><code>*/is</code></h5>
<p>Object type/kind confirmation, returns either <code>true</code> or <code>false</code>.</p>
<p><a class="anchor" id="autotoc_md1706"></a></p><h5><code>*/ensure</code></h5>
...
<li><code>errorMessage</code> - Custom error message. Following placeholders can be used:<ul>
...
<h3><a class="anchor" id="autotoc_md1707"></a>
Index</h3>
<h4><a class="anchor" id="autotoc_md1708"></a>
General utils:</h4>
<ul>
<li>`ensure`</li>
</ul>
<h4><a class="anchor" id="autotoc_md1709"></a>
Type specific utils:</h4>
<ul>
<li><b>Value</b><ul>
...
<li><b>BigInt</b><ul>
<li><a href="docs/big-int.md#big-intcoerce"><code>big-int/coerce</code></a></li>
<li><a href="docs/big-int.md#big-intensure"><code>big-int/ensure</code></a></li>
</ul>
</li>
<li><b>Array Like</b><ul>
...
<h3><a class="anchor" id="autotoc_md1710"></a>
Tests</h3>
