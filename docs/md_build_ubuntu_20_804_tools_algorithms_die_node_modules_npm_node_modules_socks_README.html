...
<title>fuzzuf: socks  &lt;a href=&quot;https://travis-ci.org/JoshGlazebrook/socks&quot;&gt;&lt;img src=&quot;https://travis-ci.org/JoshGlazebrook/socks.svg?branch=master&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;  &lt;a href=&quot;https://coveralls.io/github/JoshGlazebrook/socks?branch=v2&quot;&gt;&lt;img src=&quot;https://coveralls.io/repos/github/JoshGlazebrook/socks/badge.svg?branch=master&quot; alt=&quot;Coverage Status&quot;/&gt;&lt;/a&gt;</title>
...
<div class="title">socks <a href="https://travis-ci.org/JoshGlazebrook/socks"><object type="image/svg+xml" data="https://travis-ci.org/JoshGlazebrook/socks.svg?branch=master" style="pointer-events: none;">Build Status</object></a> <a href="https://coveralls.io/github/JoshGlazebrook/socks?branch=v2"><object type="image/svg+xml" data="https://coveralls.io/repos/github/JoshGlazebrook/socks/badge.svg?branch=master" style="pointer-events: none;">Coverage Status</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
...
Features</h2>
<ul>
<li>Supports SOCKS v4, v4a, and v5 protocols.</li>
...
<li>Supports user/pass authentication.</li>
...
Requirements</h2>
<ul>
<li>Node.js v6.0+ (Please use <a href="https://github.com/JoshGlazebrook/socks/tree/82d83923ad960693d8b774cafe17443ded7ed584">v1</a> for older versions of Node.js)</li>
</ul>
<h2><a class="anchor" id="autotoc_md10415"></a>
Looking for v1?</h2>
<ul>
...
<h1><a class="anchor" id="autotoc_md10417"></a>
Usage</h1>
...
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10419"></a>
Chaining Proxies</h1>
...
<p>This example makes a proxy chain through two SOCKS proxies to ip-api.com. Once the connection to the destination is established it sends an HTTP request to get a JSON response that returns ip info for the requesting ip.</p>
<div class="fragment"><div class="line">const options = {</div>
<div class="line">  destination: {</div>
...
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10420"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10421"></a>
...
<h1><a class="anchor" id="autotoc_md10422"></a>
Additional Examples</h1>
<p>Documentation</p>
<h1><a class="anchor" id="autotoc_md10423"></a>
Migrating from v1</h1>
<p>Looking for a guide to migrate from v1? Look here</p>
<h1><a class="anchor" id="autotoc_md10424"></a>
Api Reference:</h1>
...
<h2><a class="anchor" id="autotoc_md10425"></a>
SocksClient</h2>
<p>SocksClient establishes SOCKS proxy connections to remote destination hosts. These proxy connections are fully transparent to the server and once established act as full duplex streams. SOCKS v4, v4a, and v5 are supported, as well as the connect, bind, and associate commands.</p>
...
<tr class="markdownTableRowOdd">
<td class="markdownTableBodyNone">SOCKS v5 </td><td class="markdownTableBodyCenter">✅ </td><td class="markdownTableBodyCenter">✅ </td><td class="markdownTableBodyCenter">✅ </td><td class="markdownTableBodyCenter">✅ </td><td class="markdownTableBodyCenter">✅  </td></tr>
</table>
...
<div class="line">    port: 1080,</div>
<div class="line">    type: 5 // Proxy version (4 or 5). For v4a, just use 4.</div>
<div class="line"> </div>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10428"></a>
...
<div class="line">  }</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10429"></a>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10430"></a>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10431"></a>
...
<h1><a class="anchor" id="autotoc_md10432"></a>
Event: 'error'</h1>
<ul>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10434"></a>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10437"></a>
Further Reading:</h1>
