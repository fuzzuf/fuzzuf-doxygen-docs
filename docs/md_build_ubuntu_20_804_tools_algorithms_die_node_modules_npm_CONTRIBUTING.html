...
<div class="contents">
<div class="textblock"><h1><a class="anchor" id="autotoc_md4346"></a>
...
<div class="line">│   │                  # Directory for executable files. It&#39;s very rare that you</div>
<div class="line">│   │                  # will need to update a file in this directory.</div>
<div class="line">│   │</div>
<div class="line">│   ├── npm               # npm-cli entrypoint for bourne shell</div>
<div class="line">│   ├── npm-cli.js        # npm-cli entrypoint for node</div>
<div class="line">│   ├── npm.cmd           # npm-cli entrypoint for windows</div>
<div class="line">│   ├── npx               # npx entrypoint for bourne shell</div>
<div class="line">│   ├── npx-cli.js        # npx entrypoint for node</div>
<div class="line">│   └── npx.cmd           # npx entrypoint for windows</div>
<div class="line">│</div>
<div class="line">├── docs/  📖</div>
<div class="line">│   │                  # Directory that contains the documentation website for</div>
<div class="line">│   │                  # the npm-cli. You can run this website locally, and have</div>
<div class="line">│   │                  # offline docs! 🔥📖🤓</div>
<div class="line">│   │</div>
<div class="line">│   ├── content/          # Markdown files for site content</div>
<div class="line">│   ├── src/              # Source files for the website; gatsby related</div>
<div class="line">│   └── package.json      # Site manifest; scripts and dependencies</div>
<div class="line">│</div>
<div class="line">├── lib/  📦</div>
<div class="line">│                      # All the Good Bits(tm) of the CLI project live here</div>
<div class="line">│</div>
<div class="line">├── node_modules/  🔋</div>
<div class="line">│                      # Vendored dependencies for the CLI project (See the</div>
<div class="line">│                      # dependencies section below for more details).</div>
<div class="line">│</div>
<div class="line">├── scripts/  📜</div>
<div class="line">│                      # We&#39;ve created some helper scripts for working with the</div>
<div class="line">│                      # CLI project, specifically around managing our vendored</div>
<div class="line">│                      # dependencies, merging in pull-requests, and publishing</div>
<div class="line">│                      # releases.</div>
<div class="line">│</div>
<div class="line">├── test/  🧪</div>
<div class="line">│                      # All the tests for the CLI live in this folder. We&#39;ve</div>
<div class="line">│                      # got a lot of tests 🤓🧪🩺</div>
<div class="line">│</div>
<div class="line">├── CONTRIBUTING.md       # This file! 🎉</div>
<div class="line">└── package.json          # The projects main manifest file 📃</div>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md4350"></a>
Debugging</h1>
...
<li>Add the following comment to the pull-request: "`test this please ✅`"</li>
</ol>
...
<p>You'll notice that the bot-user will also add a 🚀 reaction to your comment to </p>
</blockquote>
...
<p>If you've updated your pull-reuqest and you'd like to run the the benchmark suite again, simple update your original comment, by adding <code>test this please ✅</code> again, or simply just adding another emoji to the <b>end</b>. _(The trigger is the phrase "test this please ✅" at the beginning of a comment. Updates will trigger as well, so long as the phrase stays at the beginning.)_.</p>
...
<p>Huh? 🤔 Got a situation you're not sure about?! Perfect! We've got some resources you can use.</p>
<ul>
...
<h2><a class="anchor" id="autotoc_md4356"></a>
