...
<div class="title">minizlib </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p>A fast zlib stream built on <a href="http://npm.im/minipass">minipass</a> and Node.js's zlib binding.</p>
...
How does this differ from the streams in ‘require('zlib’)`?</h1>
...
USAGE</h1>
<div class="fragment"><div class="line">const zlib = require(&#39;minizlib&#39;)</div>
<div class="line">const input = sourceOfCompressedData()</div>
<div class="line">const decode = new zlib.BrotliDecompress()</div>
<div class="line">const output = whereToWriteTheDecodedData()</div>
<div class="line">input.pipe(decode).pipe(output)</div>
