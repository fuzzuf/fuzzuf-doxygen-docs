...
<title>fuzzuf: normalize-package-data &lt;a href=&quot;https://travis-ci.org/npm/normalize-package-data&quot;&gt;&lt;img src=&quot;https://travis-ci.org/npm/normalize-package-data.png?branch=master&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;</title>
...
<div class="title">normalize-package-data <a href="https://travis-ci.org/npm/normalize-package-data"><img src="https://travis-ci.org/npm/normalize-package-data.png?branch=master" alt="Build Status" class="inline"/></a> </div>  </div>
</div><!--header-->
<div class="contents">
...
Installation</h1>
<div class="fragment"><div class="line">npm install normalize-package-data</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md9123"></a>
Usage</h1>
...
<div class="fragment"><div class="line">normalizeData = require(&#39;normalize-package-data&#39;)</div>
<div class="line">packageData = require(&quot;./package.json&quot;)</div>
<div class="line">normalizeData(packageData)</div>
<div class="line">// packageData is now normalized</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md9124"></a>
Strict mode</h3>
<p>You may activate strict validation by passing true as the second argument.</p>
<div class="fragment"><div class="line">normalizeData = require(&#39;normalize-package-data&#39;)</div>
<div class="line">packageData = require(&quot;./package.json&quot;)</div>
<div class="line">normalizeData(packageData, true)</div>
<div class="line">// packageData is now normalized</div>
</div><!-- fragment --><p>If strict mode is activated, only Semver 2.0 version strings are accepted. Otherwise, Semver 1.0 strings are accepted as well. Packages must have a name, and the name field must not have contain leading or trailing whitespace.</p>
<h3><a class="anchor" id="autotoc_md9125"></a>
Warnings</h3>
...
<div class="fragment"><div class="line">normalizeData = require(&#39;normalize-package-data&#39;)</div>
<div class="line">packageData = require(&quot;./package.json&quot;)</div>
<div class="line">warnFn = function(msg) { console.error(msg) }</div>
<div class="line">normalizeData(packageData, warnFn)</div>
<div class="line">// packageData is now normalized. Any number of warnings may have been logged.</div>
</div><!-- fragment --><p>You may combine strict validation with warnings by passing <code>true</code> as the second argument, and <code>warnFn</code> as third.</p>
...
<h1><a class="anchor" id="autotoc_md9127"></a>
What normalization (currently) entails</h1>
<ul>
...
<h2><a class="anchor" id="autotoc_md9130"></a>
Rules for license field</h2>
