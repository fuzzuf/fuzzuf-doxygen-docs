...
<h2><a class="anchor" id="autotoc_md10239"></a>
...
<h3><a class="anchor" id="autotoc_md10240"></a>
Note:</h3>
...
<h1><a class="anchor" id="autotoc_md10242"></a>
...
<h1><a class="anchor" id="autotoc_md10243"></a>
Installing:</h1>
...
<p><code>tsc -p ./</code></p>
<h1><a class="anchor" id="autotoc_md10244"></a>
...
<div class="line">};</div>
<div class="line">*/</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10246"></a>
Api Reference:</h1>
<h3><a class="anchor" id="autotoc_md10247"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10248"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10249"></a>
Reading Data</h2>
...
<h2><a class="anchor" id="autotoc_md10250"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md10251"></a>
...
<h3><a class="anchor" id="autotoc_md10252"></a>
SmartBuffer.readStringNT( [encoding] )</h3>
<blockquote class="doxtable">
<p><code>String</code> <b>String encoding to use</b> - Defaults to the encoding set in the constructor. </p>
</blockquote>
<p>returns <code>String</code></p>
<blockquote class="doxtable">
<p>Note: When readStringNT is called and there is no null character found, smart-buffer will read to the end of the internal Buffer. </p>
</blockquote>
<h3><a class="anchor" id="autotoc_md10253"></a>
SmartBuffer.readString( [length] )</h3>
<h3><a class="anchor" id="autotoc_md10254"></a>
SmartBuffer.readString( [encoding] )</h3>
<h3><a class="anchor" id="autotoc_md10255"></a>
SmartBuffer.readString( [length], [encoding] )</h3>
<blockquote class="doxtable">
<p><code>Number</code> <b>Length of the string to read</b> </p>
</blockquote>
<blockquote class="doxtable">
<p><code>String</code> <b>String encoding to use</b> - Defaults to the encoding set in the constructor, or utf8. </p>
</blockquote>
<p>returns <code>String</code></p>
<blockquote class="doxtable">
<p>Note: When readString is called without a specified length, smart-buffer will read to the end of the internal Buffer. </p>
</blockquote>
<h2><a class="anchor" id="autotoc_md10256"></a>
Reading Buffer Values</h2>
<h3><a class="anchor" id="autotoc_md10257"></a>
SmartBuffer.readBuffer( length )</h3>
<blockquote class="doxtable">
<p><code>Number</code> <b>Length of data to read into a Buffer</b> </p>
</blockquote>
<p>returns <code>Buffer</code></p>
<blockquote class="doxtable">
<p>Note: This function uses <code>slice</code> to retrieve the Buffer. </p>
</blockquote>
<h3><a class="anchor" id="autotoc_md10258"></a>
SmartBuffer.readBufferNT()</h3>
<p>returns <code>Buffer</code></p>
<blockquote class="doxtable">
<p>Note: This reads the next sequence of bytes in the buffer until a null (0x00) value is found. (Null terminated buffer) Note: This function uses <code>slice</code> to retrieve the Buffer. </p>
</blockquote>
...
<h3><a class="anchor" id="autotoc_md10261"></a>
SmartBuffer.writeInt8( value, [offset] )</h3>
<blockquote class="doxtable">
<p><code>Number</code> <b>A valid Int8 number</b> </p>
</blockquote>
<blockquote class="doxtable">
<p><code>Number</code> <b>The position to insert this value at</b> </p>
</blockquote>
<p>returns this</p>
<blockquote class="doxtable">
<p>Note: All write operations return <code>this</code> to allow for chaining. </p>
</blockquote>
<h2><a class="anchor" id="autotoc_md10262"></a>
...
<h3><a class="anchor" id="autotoc_md10263"></a>
SmartBuffer.writeStringNT( value, [offset], [encoding] )</h3>
<h3><a class="anchor" id="autotoc_md10264"></a>
SmartBuffer.writeStringNT( value, [offset] )</h3>
<h3><a class="anchor" id="autotoc_md10265"></a>
SmartBuffer.writeStringNT( value, [encoding] )</h3>
<blockquote class="doxtable">
<p><code>String</code> <b>String value to write</b> </p>
</blockquote>
<blockquote class="doxtable">
<p><code>Number</code> <b>The position to insert this String at</b> </p>
</blockquote>
<blockquote class="doxtable">
<p><code>String</code> <b>The String encoding to use.</b> - Defaults to the encoding set in the constructor, or utf8. </p>
</blockquote>
<p>returns this</p>
<h3><a class="anchor" id="autotoc_md10266"></a>
SmartBuffer.writeString( value, [offset], [encoding] )</h3>
<h3><a class="anchor" id="autotoc_md10267"></a>
SmartBuffer.writeString( value, [offset] )</h3>
<h3><a class="anchor" id="autotoc_md10268"></a>
...
<h3><a class="anchor" id="autotoc_md10270"></a>
SmartBuffer.writeBuffer( value, [offset] )</h3>
<blockquote class="doxtable">
<p><code>Buffer</code> <b>Buffer value to write</b> </p>
</blockquote>
<blockquote class="doxtable">
<p><code>Number</code> <b>The position to insert this Buffer's content at</b> </p>
</blockquote>
<p>returns this</p>
<h3><a class="anchor" id="autotoc_md10271"></a>
...
<h2><a class="anchor" id="autotoc_md10282"></a>
License</h2>
